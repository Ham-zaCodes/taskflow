    ...
    <div className="min-h-screen flex items-center justify-center p-4"
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] right-[10%] w-[400px] h-[400px] rounded-full"
          style={{ background: 'rgba(34,197,94,0.05)', filter: 'blur(100px)' }} />
      </div>
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-700" style={{ color: 'var(--text)' }}>Welcome back</h1>
          <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>Sign in to manage your tasks</p>
        </div>
        ...
        <div className="card p-8">
          ...
          <p className="text-sm text-center mt-6" style={{ color: 'var(--text-muted)' }}>
            ...
            <Link href="/signup" className="font-500" style={{ color: 'var(--accent)' }}>
              Create one
            </Link>
          </p>
        </div>
